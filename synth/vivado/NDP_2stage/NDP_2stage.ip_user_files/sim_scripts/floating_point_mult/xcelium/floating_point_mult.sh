...
#
# Script generated by Vivado on Tue Aug 06 14:56:27 KST 2024
# SW Build 3865809 on Sun May  7 15:04:56 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : floating_point_mult.sh
...
#
# Usage        : floating_point_mult.sh
#                floating_point_mult.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                floating_point_mult.sh [-reset_run]
#                floating_point_mult.sh [-reset_log]
#                floating_point_mult.sh [-help]
#
...
#                script (type 'floating_point_mult.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname xbip_utils_v3_0_10 -libname axi_utils_v2_0_6 -libname xbip_pipe_v3_0_6 -libname xbip_dsp48_wrapper_v3_0_4 -libname xbip_dsp48_addsub_v3_0_6 -libname xbip_dsp48_multadd_v3_0_6 -libname xbip_bram18k_v3_0_6 -libname mult_gen_v12_0_18 -libname floating_point_v7_1_15 -libname xil_defaultlib -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"
...
# script info
echo -e "floating_point_mult.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./floating_point_mult.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"/home/kimth/tools/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"/home/kimth/tools/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  xmvlog -work floating_point_v7_1_15 $xmvlog_opts +incdir+"/home/kimth/tools/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/floating_point_v7_1_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"/home/kimth/tools/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.floating_point_mult xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.floating_point_mult -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/kimth/bloominho/vivado/NDP_2stage/NDP_2stage.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log floating_point_mult_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./floating_point_mult.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: floating_point_mult.sh [-help]\n\
Usage: floating_point_mult.sh [-step]\n\
Usage: floating_point_mult.sh [-lib_map_path]\n\
Usage: floating_point_mult.sh [-reset_run]\n\
Usage: floating_point_mult.sh [-reset_log]\n\
Usage: floating_point_mult.sh [-keep_index]\n\
Usage: floating_point_mult.sh [-noclean_files]\n\n\
