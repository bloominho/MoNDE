...
simulate()
{
  xsim floating_point_add -key {Behavioral:sim_1:Functional:floating_point_add} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_d5b8.protoinst" -protoinst "protoinst_files/system.protoinst" -log simulate.log
}
