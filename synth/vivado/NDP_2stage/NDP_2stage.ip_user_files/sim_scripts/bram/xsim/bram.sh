...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot bram xil_defaultlib.bram xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim bram -key {Behavioral:sim_1:Functional:bram} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_1579.protoinst" -protoinst "protoinst_files/system.protoinst" -log simulate.log
}
