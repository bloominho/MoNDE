...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"/home/kimth/tools/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"/home/kimth/tools/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  vlogan -work floating_point_v7_1_15 $vlogan_opts +v2k +incdir+"/home/kimth/tools/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/floating_point_v7_1_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"/home/kimth/tools/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.floating_point_mult xil_defaultlib.glbl -o floating_point_mult_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./floating_point_mult_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/kimth/bloominho/vivado/NDP_1stage/NDP_1stage.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key floating_point_mult_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc floating_point_mult_simv.daidir vcs_lib c.obj)
