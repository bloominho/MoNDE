...
(
  ...
  //--- Write Address---------------------------------------
  input wire [C_ADDR_WIDTH-1:0]       ctrl_offset_0,
  input wire [C_ADDR_WIDTH-1:0]       ctrl_offset_1,
  ...
  input wire                          s_tvalid,
  input wire  [C_DATA_WIDTH-1:0]      s_tdata_0,
  input wire  [C_DATA_WIDTH-1:0]      s_tdata_1,
  ...
  output wire                         awvalid,
  input wire                          awready,
  output wire [C_ADDR_WIDTH-1:0]      awaddr_0,
  output wire [C_ADDR_WIDTH-1:0]      awaddr_1,

  output wire                         wvalid,
  input wire                          wready,
  output wire [C_DATA_WIDTH/8-1:0]    wstrb,
  output wire                         wlast,
  output wire [C_DATA_WIDTH-1:0]      wdata_0,
  output wire [C_DATA_WIDTH-1:0]      wdata_1,
...
logic [C_ADDR_WIDTH-1:0]              addr_0;
logic [C_ADDR_WIDTH-1:0]              addr_1;
...
assign wdata_0         = s_tdata_0;
assign wdata_1         = s_tdata_1;
...
assign awaddr_0 = addr_0;
assign awaddr_1 = addr_1;

always @(posedge aclk) begin 
  addr_0 <= ctrl_start ? ctrl_offset_0 :
          awxfer     ? addr_0 + C_BURST_LEN*C_DATA_WIDTH/8 : 
                       addr_0;
  addr_1 <= ctrl_start ? ctrl_offset_1 :
          awxfer     ? addr_1 + C_BURST_LEN*C_DATA_WIDTH/8 : 
                       addr_1;
end
